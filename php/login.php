...
<div align="center">
    ...
    <form name="form3" id="form3" method="post">
      ...
      <div class="login_row"><div class="login_tit">Correo electrónico: *</div><div class="login_box"><input type="text" name="iuser_3" id="iuser_3"></div></div>
      ...
      <div class="login_row"><div class="section_txt"><b>INFORMACIÓN DE CONTACTO:</b></div></div>
      ...
      <div class="login_row"><div class="login_tit">Fecha de Nacimiento: *</div><div class="login_box"><input type="date" name="iuser_10" id="iuser_10"></div></div>
      <div class="login_row"><div class="section_txt"><b>INFORMACIÓN DE DIRECCIÓN:</b></div></div>
      ...
      <div class="login_row"><div class="login_tit">Número de Tarjeta: *</div><div class="login_box"><input type="text" name="iuser_11" id="iuser11"></div></div>
      <div><input type="submit" name="btnRegister" value="REGISTRAR" class="btn btn-info"></div>
      <span class="error" id="error3"><? echo $error; ?></span>
      <br></br>
    </form>
    <div align="left"><input type="submit" name="btnAdmin" value="ADMIN" class="btn btn-warning" style="margin-bottom:20px;"></div>
